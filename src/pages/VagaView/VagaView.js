...
const VagaView = (props) => {
  ...
  return (
    <div className="container flex-grow-1">
      <div className="row">
        <div className="col">
          <h1 className="text-center mt-4">{entrada.nome}</h1>
          <h2 className="text-center">R$ {entrada.valor}</h2>
          <div className="btn-group mt-3 w-100 d-flex align-items-center justify-content-center">
            <Link to={`/edit/${entrada._id}`}  className="btn btn-outline-info">Editar</Link>
